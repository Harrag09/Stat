            ...
            <Table>
                ...
                <tbody>
                    {filteredProducts.map(product => (
                        <tr key={product._id}>
                            <td style={{ width: '30%' }}>
                                <img src={`${Url}/uploads/${product.name}.png`} alt={product.name} style={{ height: '100px', width: '100px' }} />
                            </td>
                            <td><h6>{product.name}</h6></td>
                            {windowWidth > 700 && (
                                <>
                                    <td><h6>{product.prix_achat}</h6></td>
                                    <td><h6>{product.prix_vente}</h6></td>
                                </>
                            )}
                            <td style={{ width: '4%' }}>
                    ...
                    {selectedProduct && (
                        <div style={{ fontSize: '1.4rem', marginTop: '20px' }}>
                            <div style={{ textAlign: 'center' }}>
                                <img src={`${Url}/uploads/${selectedProduct.name}.png`} alt={selectedProduct.name} style={{ height: '200px', width: '200px' }} />
                            </div>
                            <br />
                            <label>Name:</label><b> {selectedProduct.name}</b><br />
                            <label>Description:</label><b> {selectedProduct.description}</b><br />
                            <label>prix vente:</label><b> {selectedProduct.prix_vente}</b><br />
                            <label>prix achat:</label><b> {selectedProduct.prix_achat}</b><br />
                            <br />
                            <div style={{ textAlign: 'center' }}>
